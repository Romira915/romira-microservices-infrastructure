migration "state" "import_ampere_instance" {
    actions = [
        "import oci_core_vcn.ampere_vcn ocid1.vcn.oc1.ap-tokyo-1.amaaaaaaa325ehaahah2micew5kql7oizacuoep5z33ghrui4s4svbsr3yea",
